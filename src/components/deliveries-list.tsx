...
export const DeliveriesList = (path = '') => {
	...
	const getDeliveries = async () => {
		setHasPrev(false);
		setHasNext(false);
		const driverId = await getSelfId();
		const response = await apiService.page(`/deliveries/dd-deliveries/${driverId}`, pagination);
		if (response) {
